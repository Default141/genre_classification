...
def go(config: DictConfig):
    ...
    if "segregate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "artifact_root": "processed_segregated_data.csv",
                "artifact_type": "process data",
    ...
    if "random_forest" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "train_data": "processed_segregated_data.csv_train.csv:latest",
    ...
    if "evaluate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "test_data": "processed_segregated_data.csv_test.csv:latest"
            },
        )
